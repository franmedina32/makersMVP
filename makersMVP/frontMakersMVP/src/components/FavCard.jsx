...
const FavCard = (props) => {
  ...
  return (
    <div>
      ...
      <div>
        <div>
        <img src={collectionData.exchange_data[1].image_url}></img>
        <h1>{collectionData.name}</h1>
        </div>
        <div>
          <p>seven day volume: {collectionData.exchange_data[1].stats.seven_day_volume} ETH</p>
          <p>seven day sales: {collectionData.exchange_data[1].stats.seven_day_sales}</p>
        </div>
        <div>
          <p>Open Sea <a href={collectionData.exchange_data[1].exchange_url}><SiOpensea/></a></p>
        </div>
      </div> : 
